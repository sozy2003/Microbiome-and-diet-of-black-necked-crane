# animal diet NMDS beased on bray_curtis
...
set.seed(000)
spe.nmds <- metaMDS(betadiv_coi,distance="bray")#0.1437084 
spe.nmds
df_nmds_stress <-spe.nmds$stress#6.977851e-05
df_nmds_stress
...
p1
#ggsave("NMDS_BC_coi_2023.7.28.pdf", p1, width = 5, height = 4)
set.seed(000)
anosim=anosim(betadiv_coi,design_coi$SamplingSeason, permutations=999)
anosim
summary(anosim)
#figS6
